...
*   **[Flutter](https://flutter.dev/):** For cross-platform app development (iOS & Android).
*   **[Firebase](https://firebase.google.com/):** To manage authentication and the database (Firestore).
*   **[Vertex AI (Gemini)](https://cloud.google.com/vertex-ai):** As the backend AI service for grading.
